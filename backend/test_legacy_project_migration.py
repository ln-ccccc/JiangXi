...
class TestLegacyProjectMigration(unittest.TestCase):
    ...
    def _write_kmz(self):
        source_kml = Path(self.temp_dir) / "jiangxi_source.kml"
    ...
    <Placemark>
      ...
      <ExtendedData>
        <SchemaData schemaUrl="#jiangxi">
          ...
          <SimpleData name="SHI">宜春市</SimpleData>
    ...
    <Placemark>
      ...
      <ExtendedData>
        <SchemaData schemaUrl="#jiangxi">
          ...
          <SimpleData name="SHI">上饶市</SimpleData>
        ...
        with ZipFile(self.kml_path, "w") as archive:
            archive.write(source_kml, arcname="doc.kml")
